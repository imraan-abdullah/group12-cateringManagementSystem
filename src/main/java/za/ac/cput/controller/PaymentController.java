...
/*
 * PaymentController.java Controller for Payment
...
public class PaymentController {
    ...
    @PostMapping("save")
    public ResponseEntity<Payment> safe(@Valid @RequestBody Payment payment) {
    ...
    {
        List <Payment> payment = this.service.findAll();
        return ResponseEntity.ok(payment);
    }
}
